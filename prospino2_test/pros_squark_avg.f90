...
!---------------------------------------------------------------------------!
  ...
  call PROSPINO(inlo, isq_ng_in, icoll_in, energy_in, i_error_in, ss, ipart1_in, ipart2_in, 0, 0)
  call PROSPINO(inlo, isq_ng_in, icoll_in, energy_in, i_error_in, sb, ipart1_in, ipart2_in, 0, 0)
